...
describe('Класс Team', () => {
  ...
  describe('Методы', () => {
    ...
    describe('Итератор', () => {
      ...
      it('Перебирает коллекцию команды из 5 персонажей | Возвращает персонажей команды', () => {
        team.addAll(...characters);
        expect([...team]).toEqual(characters);
      });

      it('Внесены изменения в коллекции во время итерации | Возвращает обновленный список', () => {
